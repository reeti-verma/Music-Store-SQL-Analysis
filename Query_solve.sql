...
-- Q4: Which country has the best customers? We would like to throw a promotional Music Festival in the city we made the most money.
...
-- Write a query that returns the person who spend  the most money.
...
-- Return your list ordered alphabetecally by email starting A.
...
-- Q9: Find how much amount spent by each customerr on artists?
